...
object AsyncResultFunctorInstanceImplicits {
    @JvmStatic fun <D: SuperHeroesContext> instance(): AsyncResultFunctorInstance<D> =
...
object AsyncResultApplicativeInstanceImplicits {
    @JvmStatic fun <D: SuperHeroesContext> instance(): AsyncResultApplicativeInstance<D> =
...
object AsyncResultMonadInstanceImplicits {
    @JvmStatic fun <D: SuperHeroesContext> instance(): AsyncResultMonadInstance<D> =
...
object AsyncResultMonadErrorInstanceImplicits {
    @JvmStatic fun <D: SuperHeroesContext> instance(): AsyncResultMonadErrorInstance<D> =
